...
import com.network_monitor.portal_service.model.dto.TokenResponse;
...
public class KeyCloakService {
    ...
    public List<com.network_monitor.portal_service.model.dto.RoleResponse> getAllRealmRoles() {
        return getRealmResource().roles().list().stream()
                ...
                .map(role -> com.network_monitor.portal_service.model.dto.RoleResponse.builder()
                        .name(role.getName())
